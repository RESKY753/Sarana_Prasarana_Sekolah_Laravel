    ...
    <form id="form-siswa" action="{{ Route('ProsesLoginSiswa')}}" method="post">
      ...
      <div class="mb-3">
        ...
        <div class="input-group-custom">
          ...
          <input type="number" name="nis" class="form-control-custom" placeholder="Masukkan NIS Anda" required>
        </div>
      </div>
    ...
    <form id="form-admin" action="{{ Route('ProsesLoginAdmin')}}" method="post">
      ...
      <div class="mb-3">
        ...
        <div class="input-group-custom">
          ...
          <input type="text" class="form-control-custom" placeholder="Masukkan Username" name="username" required>
        </div>
      </div>
      ...
      <button type="submit" class="btn-login" style="background: var(--student-blue);">Masuk Sebagai Admin</button>
    </form>
