...
<head>
    ...
    <title>Preview Tambah Siswa - SarprasCare</title>
    ...
    <div class="container py-5">
        <div class="row justify-content-center">
            <div class="col-lg-11 col-xl-10">
                ...
                <div class="mb-4">
                    <h2 class="form-header-title mb-1">Tambah Data Siswa</h2>
                    <p class="text-muted small">Pendaftaran akun siswa baru sistem SarprasCare</p>
                </div>
                ...
                <div class="premium-card overflow-hidden">
                    <div class="row g-0">
                        ...
                        <div class="col-md-8 p-4 p-lg-5">
                            <form method="POST" action="{{ url('Admin/TambahSiswa') }}">
                                @csrf
                                <div class="row g-4">
                                    <!-- NIS -->
                                    <div class="col-md-12">
                                        ...
                                        <input type="number" class="form-control custom-input"
                                            placeholder="Masukkan nomor induk siswa" name="nis" maxlength="10">
                                        @error('nis')
                                    ...
                                    <!-- Password -->
                                    <div class="col-md-6">
                                        <label class="input-label">Password Awal</label>
