...
<head>
  ...
  <style>
    ...
    .badge-danger { background: #fad6d6; color: #9e0e0e; }
    .badge-success { background: #cfeed8; color: #166534; }
    .badge-rejected { background: #fef2f2; color: #991b1b; }
    .badge-diproses { background: #e0f2fe; color: #0369a1; }  /* Diproses */
    .status-badge.baru {background:#e0f2fe; color: #0dcaf0; /* biru muda / info */}
  ...
  <main class="main-content">
    ...
    <div class="content-body p-4 p-lg-5">
      ...
      <div class="welcome-banner text-center text-md-start">
        ...
        <a href="{{ url('/Siswa/KirimAspirasi') }}" class="btn btn-primary bg-white text-dark border-0 fw-bold rounded-pill px-4 py-2 text-decoration-none d-inline-block">
...
@endswitch
          ...
          <div class="report-info">
            ...
            <div>
              <i class="fa-solid fa-calendar"></i> {{ $data->tanggal_lapor }}
            </div>
          </div>
        </div>
          ...
          <div class="modal-body p-4">
            <div class="text-center mb-4">
              <div class="position-relative d-inline-block">
                <img src="https://ui-avatars.com/api/?name={{ auth('siswa')->user()->Nama }}&background=4361ee&color=fff" class="rounded-circle border border-2 border-white" width="90">
            ...
            <!-- NIS / NIP -->
            <div class="mb-3">
              <label class="form-label small fw-bold text-muted">Nomor Induk (NIS)</label>
              {{-- mengambil nis dari sesi login --}}
              <input type="text" class="form-control rounded-3 border-slate-200 bg-light" value="{{ auth('siswa')->user()->nis }}" readonly>
            ...
            <div class="mb-3">
              ...
              {{-- mengambil nama siswa dari sesi login --}}
              <input type="text" class="form-control rounded-3 border-slate-200" value="{{ auth('siswa')->user()->Nama }}">
            </div>

            <!-- Kelas / Jabatan -->
            <div class="mb-4">
              <label class="form-label small fw-bold text-muted">Kelas</label>
              <input type="text" name="" id="" class="form-control rounded-3 border-slate-200 bg-light" value="{{ auth('siswa')->user()->kelas }}" readonly>
            </div>
