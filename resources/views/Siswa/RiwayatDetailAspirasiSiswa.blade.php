  ...
  <aside class="sidebar-wrapper">
    ...
    <div class="sidebar-footer">
      ...
      <form action="{{ url('Admin/LogoutSiswa') }}" method="post">
        @csrf
        <button type="button" class="btn btn-danger bg-opacity-25 border-0 w-100 py-3 rounded-4 fw-bold text-decoration-none d-block text-center" style="color: #fca5a5;">
      ...
      <div class="row justify-content-center">
        <div class="col-lg-10 col-xl-9">
          ...
          <div class="mb-4 d-flex align-items-center justify-content-between">
            ...
            <a href="/Siswa/RiwayatAspirasiSiswa" class="btn btn-light rounded-3 btn-sm fw-bold text-muted border">
          ...
          <div class="detail-container">
            ...
            <div class="detail-header ">
              ...
              <form action="/Siswa/RiwayatAspirasi/Delete/{{ $aspirasi->id_aspirasi }}" method="post">
           @csrf
           @method('DELETE')
              <div class="d-flex gap-2">
                <button class="btn btn-outline-danger btn-sm rounded-3 fw-bold" onclick="confirmHapus(this); return false;">
            ...
            <div class="content-section">
              ...
              <div class="box-content box-feedback">
                <div class="d-flex align-items-center gap-2 mb-2">
                  ...
                  <span class="fw-bold small">Admin Sarpras</span>
                </div>
...
function confirmHapus(btn) {
   MyAlert.show({
        ...
        message: 'Kamu akan menghapus laporan ini. Yakin mau hapus?',
        showCancel: true,
