            ...
            <div class="row justify-content-center">
                <div class="col-lg-10 col-xl-9">
                    ...
                    <div class="mb-4 d-flex align-items-center justify-content-between">
                        ...
                        <a href="/Siswa/RiwayatAspirasiSiswa"
                        ...
                        <div class="detail-header ">
                            ...
                            <form action="/Siswa/RiwayatAspirasi/Delete/{{ $aspirasi->id_aspirasi }}" method="post">
                                ...
                                <div class="d-flex gap-2">
                                    <button class="btn btn-outline-danger btn-sm rounded-3 fw-bold"
                                        onclick="confirmHapus(this); return false;">
                ...
                <div class="p-3 rounded-4 bg-light border text-center">
                    <p class="small text-muted mb-0">Butuh bantuan lebih lanjut terkait laporan ini? <a href="#"
                            class="fw-bold text-primary">Hubungi Admin</a></p>
                </div>
