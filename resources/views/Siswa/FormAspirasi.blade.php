    ...
    <aside class="sidebar-wrapper">
        ...
        <div class="sidebar-footer">
            ...
            <form action="{{ url('Siswa/LogoutSiswa') }}" method="post">
                @csrf
                <button onclick="confirmlogout(this); return false;" return false;"
            ...
            <div class="row justify-content-center" id="form-section">
                <div class="col-lg-8 col-xl-7">
                    <div class="form-container">
                        <h5 class="fw-800 mb-4"><i class="fa-solid fa-file-pen text-primary me-2"></i> Form Pelaporan &
                            Aspirasi</h5>
                        ...
                        <form action="/Siswa/Store" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="judul_aspirasi" class="form-control"
                                    placeholder="Contoh: Perbaikan AC Kelas" required>
                            </div>
                                    ...
                                    <select class="form-select" name="id_kategori" required>
                                        ...
                                        @foreach ($kategori as $kategori)
                                            <option value="{{ $kategori->id_kategori }}"
                                                ...
                                                {{ $kategori->ket_kategori }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Tanggal Lapor</label>
                                    <input type="date" class="form-control" name="tanggal_lapor"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="lokasi"
                                    placeholder="Contoh: Lab Komputer 1 / Kantin" required>
                            </div>

                            <div class="mb-3">
                                <label class="form-label">Keterangan / Detail</label>
                                <textarea class="form-control" rows="3" name="ket_aspirasi"
                                    placeholder="Jelaskan secara detail kerusakan atau keadaan..." required></textarea>
                            </div>
